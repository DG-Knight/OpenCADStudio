...
v7. The Python feature has explicit writes for **32 of 43** canvas kinds: 31
...
Continue with **Wipeout** (queue item 11). Leader is done except for its W
